...
public class Test implements Serializable {
     ...
     *
     */
    public Test(long id, long authorId, String name, String description, List<Task> tasks, List<Tag> tags,
    ...
    public boolean equals(Object o) {
        ...
        if (tags != null ? !tags.equals(test.tags) : test.tags != null) return false;
