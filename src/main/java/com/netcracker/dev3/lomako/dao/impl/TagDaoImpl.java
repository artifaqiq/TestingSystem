...
public enum TagDaoImpl implements TagDao {
    ...
    private static final String SELECT_TAG_BY_TITLE_SQL =
    ...
    public Tag findByTitle(String title) {
        ...
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement selectUserById = connection.prepareStatement(SELECT_TAG_BY_TITLE_SQL);
            selectUserById.setString(1, title);
