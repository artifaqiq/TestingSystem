 ...
 */
package com.netcracker.dev3.lomako.dao.user.impl;
...
public enum  UserDaoImpl implements UserDao {
    ...
    private static final String SELECT_ALL_SQL =
            "SELECT id, email, encrypted_password, first_name, last_name, role_id FROM users";
    ...
    public User findOne(Long primaryKey) throws SQLException{
        ...
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement selectUserById = connection.prepareStatement(SELECT_BY_ID_SQL);
    ...
    public Iterable<User> findAll() throws SQLException{
        ...
        try(Connection connection = connectionPool.getConnection()) {
            PreparedStatement selectAll = connection.prepareStatement(SELECT_ALL_SQL);
    ...
    public Long count() throws SQLException {
        ...
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement selectCountAll = connection.prepareStatement(COUNT_ALL_SQL);
    ...
    public void delete(User entity) throws SQLException{
        ...
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement deleteUserById = connection.prepareStatement(DELETE_BY_ID_SQL);
    ...
    public boolean exists(Long primaryKey) throws SQLException{
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement existsById = connection.prepareStatement(EXISTS_BY_ID_SQL);
    ...
    public User findByEmail(String email) throws SQLException {
        ...
        try(Connection connection = connectionPool.getConnection()) {
            ...
            PreparedStatement selectUserById = connection.prepareStatement(SELECT_BY_EMAIL_SQL);
